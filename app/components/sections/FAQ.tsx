...
const faqs = [
  ...
  {
    q: "レンタルタックルはありますか？",
    a: "はい、ロッド・リール・ルアーなどのタックル一式をレンタルいただけます。手ぶらでお越しいただいても大丈夫です。詳細はLINEでご確認ください。",
  },
  {
    q: "雨の日は出船しますか？",
  ...
  {
    q: "アカメを狙いたいのですが？",
    a: "専用の「アカメ便」をご用意しております。シーズンや水位などにより釣果は変動しますが、徳島は国内屈指のアカメフィールドです。詳細はLINEでお問い合わせください。",
  },
];
