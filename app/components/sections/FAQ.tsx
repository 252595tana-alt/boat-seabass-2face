...
const faqs = [
  ...
  {
    q: "レンタルタックルはありますか？",
    a: "はい、ロッド・リール・ルアーなどのタックル一式をレンタルいただけます。手ぶらでお越しいただいても大丈夫です。詳細はLINEにてご確認ください。",
  },
  {
    q: "雨の日は出船しますか？",
    a: "小雨程度であれば通常通り出船いたします。台風や強風・高波など、安全に支障があると判断した場合は中止となります。当日の天候は前日〜当日朝にLINEにてご連絡いたします。",
  },
  {
    q: "駐車場はありますか？",
  ...
  {
    q: "アカメを狙いたいのですが？",
    a: "専用の「アカメ便」をご用意しております。シーズンや水位などにより釣果は変動しますが、徳島は国内屈指のアカメフィールドです。詳細はLINEにてお問い合わせください。",
  },
];
